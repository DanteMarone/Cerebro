...
*   **Task Scheduling:** Schedule prompts for agents to run at specific times, with optional repetition and OS scheduler integration. Inline editing and bulk editing make task management quick. (Details: [Application Tabs - Tasks](docs/app_tabs.md#tasks-tab))
